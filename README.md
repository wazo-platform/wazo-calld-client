...
c.calls.pause_record(call['id'])
c.calls.resume_record(call['id'])
...
voicemail = c.voicemails.get_voicemail_folder('voicemail-id', 'folder-id')
voicemail = c.voicemails.get_voicemail_folder_from_user('folder-id')
voicemail = c.voicemails.get_voicemail_message('my-voicemail-id', 'message-id')
voicemail = c.voicemails.get_voicemail_message_from_user('message-id')
voicemail = c.voicemails.move_voicemail_message('my-voicemail-id', 'message-id', 'folder-id')
voicemail = c.voicemails.move_voicemail_message_from_user('message-id', 'folder-id')
voicemail = c.voicemails.delete_voicemail_message('my-voicemail-id', 'message-id')
voicemail = c.voicemails.delete_voicemail_message_from_user('message-id')
voicemail = c.voicemails.get_voicemail_recording('my-voicemail-id', 'message-id')
voicemail = c.voicemails.get_voicemail_recording_from_user('message-id')
voicemail = c.voicemails.create_voicemail_greeting('my-voicemail-id', 'unavailable', 'wav-data')
voicemail = c.voicemails.create_voicemail_greeting_from_user('unavailable', 'wav-data')
voicemail = c.voicemails.voicemail_greeting_exists('my-voicemail-id', 'unavailable')
voicemail = c.voicemails.voicemail_greeting_from_user_exists('unavailable')
voicemail = c.voicemails.copy_voicemail_greeting('my-voicemail-id', 'unavailable', 'busy')
voicemail = c.voicemails.copy_voicemail_greeting_from_user('unavailable', 'busy')
voicemail = c.voicemails.update_voicemail_greeting('my-voicemail-id', 'unavailable', 'wav-data')
voicemail = c.voicemails.update_voicemail_greeting_from_user('unavailable', 'wav-data')
voicemail = c.voicemails.delete_voicemail_greeting('my-voicemail-id', 'unavailable')
voicemail = c.voicemails.delete_voicemail_greeting_from_user('unavailable')
